...
(function (factory) {
    ...
    var list = (function () {
        ...
        return { head: head, last: last, initial: initial, tail: tail, sum: sum, from: from, compact: compact, clusterBy: clusterBy };
    })();
    ...
    var range = (function () {
        ...
        var WrappedRange = function (sc, so, ec, eo) {
            ...
            this.listPara = function () {
                ...
                var aPara = list.compact(
                    $.map(aNode, function (node) {
            ...
            fnShowDialog(
                ...
                function (sLinkUrl) {
                    ...
                    if (agent.bMSIE && rng.isCollapsed()) {
                        ...
                        var $anchor = $("#linkAnchor").removeAttr("id").attr("href", sLinkUrlWithProtocol);
    ...
    var EventHandler = function () {
        ...
        var hKeydown = function (event) {
            ...
            if (keyCode === key.TAB && oLayoutInfo.editable().data("tabsize")) {
                ...
                if (keyCode === key.BACKSPACE || keyCode === key.ENTER || keyCode === key.SPACE) {
            ...
            if (dom.isControlSizing(event.target)) {
                ...
                $editor
                    .on("mousemove", function (event) {
                        posDistance = { x: event.clientX - posStart.left, y: event.clientY - (posStart.top - scrollTop) };
        ...
        var hStatusbarMousedown = function (event) {
            ...
            var hMouseup = function () {
                $document.unbind("mousemove", hMousemove).unbind("mouseup", hMouseup);
            };
    ...
    var Renderer = function () {
        ...
        tplToolbarInfo = {
            picture: function (lang) {
                return (
                    ...
                    lang.image.image +
                    '" data-event="showImageDialog" tabindex="-1"><i class="fa icon fa-picture-o icon-picture"></i></button>'
                );
            },
            link: function (lang) {
                return (
                    '<button type="button" class="btn btn-primary" title="' +
                    lang.link.link +
                    '" data-event="showLinkDialog" data-shortcut="Ctrl+K" data-mac-shortcut="⌘+K" tabindex="-1"><i class="fa icon fa-link icon-link"></i></button>'
                );
            },
            video: function (lang) {
                return (
                    '<button type="button" class="btn btn-primary" title="' +
                    lang.video.video +
                    '" data-event="showVideoDialog" tabindex="-1"><i class="fa icon fa-youtube-play icon-play"></i></button>'
                );
            },
            table: function (lang) {
                return (
                    '<button type="button" class="btn btn-primary dropdown-toggle" title="' +
                    lang.table.table +
                    '" data-toggle="dropdown" tabindex="-1"><i class="fa fa-table"></i> <span class="caret"></span></button>' +
            ...
            style: function (lang) {
                return (
                    '<button type="button" class="btn btn-primary dropdown-toggle" title="' +
                    lang.style.style +
                    '" data-toggle="dropdown" tabindex="-1"><i class="fa fa-magic"></i> <span class="caret"></span></button>' +
                    '<ul class="dropdown-menu">' +
                    '<li><a data-event="formatBlock" data-value="p">' +
                    lang.style.normal +
                    "</a></li>" +
                    '<li><a data-event="formatBlock" data-value="blockquote"><blockquote>' +
                    lang.style.blockquote +
                    "</blockquote></a></li>" +
                    '<li><a data-event="formatBlock" data-value="pre">' +
                    lang.style.pre +
                    "</a></li>" +
                    '<li><a data-event="formatBlock" data-value="h1"><h1>' +
                    lang.style.h1 +
                    "</h1></a></li>" +
                    '<li><a data-event="formatBlock" data-value="h2"><h2>' +
                    lang.style.h2 +
                    "</h2></a></li>" +
                    '<li><a data-event="formatBlock" data-value="h3"><h3>' +
                    lang.style.h3 +
                    "</h3></a></li>" +
                    '<li><a data-event="formatBlock" data-value="h4"><h4>' +
                    lang.style.h4 +
                    "</h4></a></li>" +
                    '<li><a data-event="formatBlock" data-value="h5"><h5>' +
                    lang.style.h5 +
                    "</h5></a></li>" +
                    '<li><a data-event="formatBlock" data-value="h6"><h6>' +
                    lang.style.h6 +
                    "</h6></a></li>" +
                    "</ul>"
                );
            ...
            fontsize: function (lang) {
                return (
                    ...
                    lang.font.size +
                    '" tabindex="-1"><span class="note-current-fontsize">11</span> <b class="caret"></b></button>' +
                    '<ul class="dropdown-menu">' +
                    '<li><a data-event="fontSize" data-value="8"><i class="fa icon fa-check icon-ok"></i> 8</a></li>' +
                    '<li><a data-event="fontSize" data-value="9"><i class="fa icon fa-check icon-ok"></i> 9</a></li>' +
                    '<li><a data-event="fontSize" data-value="10"><i class="fa icon fa-check icon-ok"></i> 10</a></li>' +
                    '<li><a data-event="fontSize" data-value="11"><i class="fa icon fa-check icon-ok"></i> 11</a></li>' +
                    '<li><a data-event="fontSize" data-value="12"><i class="fa icon fa-check icon-ok"></i> 12</a></li>' +
                    '<li><a data-event="fontSize" data-value="14"><i class="fa icon fa-check icon-ok"></i> 14</a></li>' +
                    '<li><a data-event="fontSize" data-value="18"><i class="fa icon fa-check icon-ok"></i> 18</a></li>' +
                    '<li><a data-event="fontSize" data-value="24"><i class="fa icon fa-check icon-ok"></i> 24</a></li>' +
                    '<li><a data-event="fontSize" data-value="36"><i class="fa icon fa-check icon-ok"></i> 36</a></li>' +
                    "</ul>"
                );
            },
            color: function (lang) {
                return (
                    '<button type="button" class="btn btn-primary note-recent-color" title="' +
                    lang.color.recent +
                    '" data-event="color" data-value=\'{"backColor":"yellow"}\' tabindex="-1"><i class="fa icon fa-font icon-font" style="color:black;background-color:yellow;"></i></button>' +
                    '<button type="button" class="btn btn-primary dropdown-toggle" title="' +
                    lang.color.more +
                    ...
                    "</div>" +
                    '<div class="note-color-reset" data-event="backColor" data-value="inherit" title="' +
            ...
            bold: function (lang) {
                return (
                    '<button type="button" class="btn btn-primary" title="' +
                    lang.font.bold +
                    '" data-shortcut="Ctrl+B" data-mac-shortcut="⌘+B" data-event="bold" tabindex="-1"><i class="fa icon fa-bold icon-bold"></i></button>'
                );
            },
            italic: function (lang) {
                return (
                    '<button type="button" class="btn btn-primary" title="' +
                    lang.font.italic +
                    '" data-shortcut="Ctrl+I" data-mac-shortcut="⌘+I" data-event="italic" tabindex="-1"><i class="fa icon fa-italic icon-italic"></i></button>'
                );
            },
            underline: function (lang) {
                return (
                    '<button type="button" class="btn btn-primary" title="' +
                    lang.font.underline +
                    '" data-shortcut="Ctrl+U" data-mac-shortcut="⌘+U" data-event="underline" tabindex="-1"><i class="fa fa-underline"></i></button>'
                );
            },
            clear: function (lang) {
                return (
                    '<button type="button" class="btn btn-primary" title="' +
                    lang.font.clear +
                    '" data-shortcut="Ctrl+\\" data-mac-shortcut="⌘+\\" data-event="removeFormat" tabindex="-1"><i class="fa fa-eraser"></i></button>'
                );
            },
            ul: function (lang) {
                return (
                    ...
                    '" data-shortcut="Ctrl+Shift+8" data-mac-shortcut="⌘+⇧+7" data-event="insertUnorderedList" tabindex="-1"><i class="fa fa-list-ul"></i></button>'
                );
            },
            ol: function (lang) {
                return (
                    '<button type="button" class="btn btn-primary" title="' +
                    lang.lists.ordered +
                    '" data-shortcut="Ctrl+Shift+7" data-mac-shortcut="⌘+⇧+8" data-event="insertOrderedList" tabindex="-1"><i class="fa fa-list-ol"></i></button>'
                );
            },
            paragraph: function (lang) {
                return (
                    ...
                    '" data-toggle="dropdown" tabindex="-1"><i class="fa icon fa-align-left icon-align-left"></i>  <span class="caret"></span></button>' +
                    '<ul class="dropdown-menu">' +
                    "<li>" +
                    '<div class="note-align btn-group">' +
                    '<button type="button" class="btn btn-primary" title="' +
                    lang.paragraph.left +
                    '" data-shortcut="Ctrl+Shift+L" data-mac-shortcut="⌘+⇧+L" data-event="justifyLeft" tabindex="-1"><i class="fa icon fa-align-left icon-align-left"></i></button>' +
                    '<button type="button" class="btn btn-primary" title="' +
                    lang.paragraph.center +
                    '" data-shortcut="Ctrl+Shift+E" data-mac-shortcut="⌘+⇧+E" data-event="justifyCenter" tabindex="-1"><i class="fa icon fa-align-center icon-align-center"></i></button>' +
                    '<button type="button" class="btn btn-primary" title="' +
                    lang.paragraph.right +
                    '" data-shortcut="Ctrl+Shift+R" data-mac-shortcut="⌘+⇧+R" data-event="justifyRight" tabindex="-1"><i class="fa icon fa-align-right icon-align-right"></i></button>' +
                    '<button type="button" class="btn btn-primary" title="' +
                    lang.paragraph.justify +
                    '" data-shortcut="Ctrl+Shift+J" data-mac-shortcut="⌘+⇧+J" data-event="justifyFull" tabindex="-1"><i class="fa icon fa-align-justify icon-align-justify"></i></button>' +
                    "</div>" +
                    "</li>" +
                    "<li>" +
                    ...
                    '" data-shortcut="Ctrl+[" data-mac-shortcut="⌘+[" data-event="outdent" tabindex="-1"><i class="fa icon fa-outdent icon-indent-left"></i></button>' +
                    '<button type="button" class="btn btn-primary" title="' +
                    lang.paragraph.indent +
                    '" data-shortcut="Ctrl+]" data-mac-shortcut="⌘+]" data-event="indent" tabindex="-1"><i class="fa icon fa-indent icon-indent-right"></i></button>' +
                    "</li>" +
                    "</ul>"
                );
            },
            height: function (lang) {
                return (
                    '<button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" title="' +
                    lang.font.height +
                    '" tabindex="-1"><i class="fa icon fa-text-height icon-text-height"></i>&nbsp; <b class="caret"></b></button>' +
                    '<ul class="dropdown-menu">' +
                    '<li><a data-event="lineHeight" data-value="1.0"><i class="fa icon fa-check icon-ok"></i> 1.0</a></li>' +
                    '<li><a data-event="lineHeight" data-value="1.2"><i class="fa icon fa-check icon-ok"></i> 1.2</a></li>' +
                    '<li><a data-event="lineHeight" data-value="1.4"><i class="fa icon fa-check icon-ok"></i> 1.4</a></li>' +
                    '<li><a data-event="lineHeight" data-value="1.5"><i class="fa icon fa-check icon-ok"></i> 1.5</a></li>' +
                    '<li><a data-event="lineHeight" data-value="1.6"><i class="fa icon fa-check icon-ok"></i> 1.6</a></li>' +
                    '<li><a data-event="lineHeight" data-value="1.8"><i class="fa icon fa-check icon-ok"></i> 1.8</a></li>' +
                    '<li><a data-event="lineHeight" data-value="2.0"><i class="fa icon fa-check icon-ok"></i> 2.0</a></li>' +
                    '<li><a data-event="lineHeight" data-value="3.0"><i class="fa icon fa-check icon-ok"></i> 3.0</a></li>' +
                    "</ul>"
                );
            },
            help: function (lang) {
                return (
                    '<button type="button" class="btn btn-primary" title="' +
                    lang.options.help +
                    '" data-shortcut="Ctrl+/" data-mac-shortcut="⌘+/" data-event="showHelpDialog" tabindex="-1"><i class="fa fa-question"></i></button>'
                );
            },
            fullscreen: function (lang) {
                return (
                    '<button type="button" class="btn btn-primary" title="' +
                    lang.options.fullscreen +
                    '" data-event="fullscreen" tabindex="-1"><i class="fa fa-arrows-alt"></i></button>'
                );
            },
            codeview: function (lang) {
                return (
                    '<button type="button" class="btn btn-primary" title="' + lang.options.codeview + '" data-event="codeview" tabindex="-1"><i class="fa fa-code"></i></button>'
                );
            },
        };
        tplPopover = function (lang) {
            return (
                ...
                '<button type="button" class="btn btn-primary" title="' +
                lang.link.edit +
                '" data-event="showLinkDialog" tabindex="-1"><i class="fa icon fa-edit icon-edit"></i></button>' +
                '<button type="button" class="btn btn-primary" title="' +
                lang.link.unlink +
                '" data-event="unlink" tabindex="-1"><i class="fa icon fa-unlink icon-unlink"></i></button>' +
                '<button type="button" class="btn btn-primary" title="' +
                lang.video.videoLink +
                '" data-event="showVideoDialog" tabindex="-1"><i class="fa icon fa-youtube-play icon-play"></i></button>' +
                "</div>" +
                "</div>" +
                "</div>" +
                ...
                '<div class="btn-group">' +
                '<button type="button" class="btn btn-primary" title="' +
                lang.image.resizeFull +
                '" data-event="resize" data-value="1" tabindex="-1"><span class="note-fontsize-10">100%</span> </button>' +
                '<button type="button" class="btn btn-primary" title="' +
                lang.image.resizeHalf +
                '" data-event="resize" data-value="0.5" tabindex="-1"><span class="note-fontsize-10">50%</span> </button>' +
                '<button type="button" class="btn btn-primary" title="' +
                lang.image.resizeQuarter +
                '" data-event="resize" data-value="0.25" tabindex="-1"><span class="note-fontsize-10">25%</span> </button>' +
                "</div>" +
                '<div class="btn-group">' +
                '<button type="button" class="btn btn-primary" title="' +
                lang.image.floatLeft +
                '" data-event="floatMe" data-value="left" tabindex="-1"><i class="fa icon fa-align-left icon-align-left"></i></button>' +
                '<button type="button" class="btn btn-primary" title="' +
                lang.image.floatRight +
                '" data-event="floatMe" data-value="right" tabindex="-1"><i class="fa icon fa-align-right icon-align-right"></i></button>' +
                '<button type="button" class="btn btn-primary" title="' +
                lang.image.floatNone +
                '" data-event="floatMe" data-value="none" tabindex="-1"><i class="fa icon fa-align-justify icon-align-justify"></i></button>' +
                "</div>" +
                "</div>" +
                "</div>" +
                "</div>"
        ...
        var tplShortcutPara = function (lang) {
            return (
                ...
                "<thead>" +
                "<tr><th></th><th>" +
                lang.shortcut.paragraphFormatting +
                "</th></tr>" +
                "</thead>" +
                "<tbody>" +
                "<tr><td>⌘ + ⇧ + L</td><td>" +
        ...
        var tplShortcutTable = function (lang) {
            return (
                ...
                "<tbody>" +
                "<tr><td>" +
                tplShortcutAction(lang) +
                "</td><td>" +
                tplShortcutText(lang) +
                "</td></tr>" +
                "<tr><td>" +
                tplShortcutStyle(lang) +
                "</td><td>" +
                tplShortcutPara(lang) +
                "</td></tr>" +
                "</tbody>" +
                "</table>"
            );
        ...
        tplDialog = function (lang) {
            return (
                ...
                '<button href="#" class="btn btn-primary note-image-btn disabled" disabled="disabled">' +
                lang.image.insert +
                "</button>" +
                "</div>" +
                "</div>" +
                ...
                "</div>" +
                '<div class="modal-footer">' +
                '<button href="#" class="btn btn-primary note-link-btn disabled" disabled="disabled">' +
                lang.link.insert +
                "</button>" +
                "</div>" +
                "</div>" +
                ...
                "</div>" +
                '<div class="modal-footer">' +
                '<button href="#" class="btn btn-primary note-video-btn disabled" disabled="disabled">' +
                lang.video.insert +
                "</button>" +
                "</div>" +
                "</div>" +
