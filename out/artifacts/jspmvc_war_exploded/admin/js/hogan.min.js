    ...
    (a.Template = function (a, c, d, e) {
        ...
        (a.Template.prototype = {
            ...
            s: function (a, b, c, d, e, f, g) {
                var h;
                return k(a) && a.length === 0
                    ? !1
                    : (typeof a == "function" && (a = this.ls(a, b, c, d, e, f, g)), (h = a === "" || !!a), !d && h && b && b.push(typeof a == "object" ? a : b[b.length - 1]), h);
            },
            d: function (a, b, c, d) {
                var e = a.split("."),
                    f = this.f(e[0], b, c, d),
    ...
    (function (a) {
        ...
        function p(a) {
            ...
            for (var c = 0, d = a.length; c < d; c++) {
                var e = a[c].tag;
                e == "#"
                    ? (b += q(a[c].nodes, a[c].n, o(a[c].n), a[c].i, a[c].end, a[c].otag + " " + a[c].ctag))
                    : e == "^"
                    ? (b += r(a[c].nodes, a[c].n, o(a[c].n)))
                    : e == "<" || e == ">"
                    ? (b += s(a[c]))
                    : e == "{" || e == "&"
                    ? (b += t(a[c].n, o(a[c].n)))
        ...
        (a.scan = function (c, d) {
            ...
            function y(a, b) {
                w();
                if (a && x()) for (var c = t, d; c < q.length; c++) q[c].tag || ((d = q[c + 1]) && d.tag == ">" && (d.indent = q[c].toString()), q.splice(c, 1));
                else b || q.push({ tag: "\n" });
                (r = !1), (t = q.length);
            }
            function z(a, b) {
            ...
            for (s = 0; s < e; s++)
                m == f
                    ? j(u, c, s)
                        ...
                        : (p += c.charAt(s))
                    : m == k
                    ? ((s += u.length - 1), (o = g[c.charAt(s + 1)]), (n = o ? c.charAt(s + 1) : "_v"), n == "=" ? ((s = z(c, s)), (m = f)) : (o && s++, (m = l)), (r = s))
                    : j(v, c, s)
                    ? (q.push({ tag: n, n: i(p), otag: u, ctag: v, i: n == "/" ? r - v.length : s + u.length }),
                      (p = ""),
                      (s += v.length - 1),
                      (m = f),
                      n == "{" && (v == "}}" ? s++ : h(q[q.length - 1])))
                    : (p += c.charAt(s));
            return y(r, !0), q;
        }),
