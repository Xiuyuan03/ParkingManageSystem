                ...
                window.setTimeout(function () {
                    ...
                    a.focus(),
                        a.is(":visible") &&
                            ...
                            (b.setSelectionRange ? b.setSelectionRange(c, c) : b.createTextRange && ((d = b.createTextRange()), d.collapse(!1), d.select()));
                }, 0);
        }
        function z(b) {
            b = a(b)[0];
        ...
        function M(a, c, d, e) {
            ...
            for (;;) {
                ...
                if (
                    ...
                    h.length > 0 && ((h = e.createSearchChoice.call(this, h, c)), h !== b && null !== h && e.id(h) !== b && null !== e.id(h)))
                ) {
        ...
        if (window.Select2 === b) {
            ...
            (j = a(document)),
                        ...
                        (this.opts = c = this.prepareOpts(c)),
                            ...
                            a.fn.mousewheel &&
                                d.mousewheel(function (a, b, c, e) {
                                    ...
                                    e > 0 && 0 >= f - e
                                        ? (d.scrollTop(0), A(a))
                                        : 0 > e && d.get(0).scrollHeight - d.scrollTop() + e <= d.height() && (d.scrollTop(d.get(0).scrollHeight - d.height()), A(a));
                                }),
                            t(e),
                            ...
                            if (d.val().length < f.minimumInputLength)
                                return (
                                    J(f.formatInputTooShort, "formatInputTooShort")
                                        ? n("<li class='select2-no-results'>" + f.formatInputTooShort(d.val(), f.minimumInputLength) + "</li>")
                                        : n(""),
                            ...
                            if (f.maximumInputLength && d.val().length > f.maximumInputLength)
                                return (
                                    J(f.formatInputTooLong, "formatInputTooLong")
                                        ? n("<li class='select2-no-results'>" + f.formatInputTooLong(d.val(), f.maximumInputLength) + "</li>")
                                        : n(""),
                                    void 0
                                );
                    ...
                    getPlaceholderOption: function () {
                        if (this.select) {
                            ...
                            if (this.opts.placeholderOption !== b)
                                return (
                                    ("first" === this.opts.placeholderOption && a) || ("function" == typeof this.opts.placeholderOption && this.opts.placeholderOption(this.select))
                                );
                            ...
                            if ("copy" === this.opts.width || "resolve" === this.opts.width) {
                                ...
                                return "resolve" === this.opts.width
                                    ? ((c = this.opts.element.css("width")),
                                      c.indexOf("%") > 0 ? c : 0 === this.opts.element.outerWidth(!1) ? "auto" : this.opts.element.outerWidth(!1) + "px")
                                    : null;
                            }
                ...
                (e = N(d, {
                    ...
                    close: function (a) {
                        this.opened() &&
                            (this.parent.close.apply(this, arguments), (a = a || { focus: !0 }), this.focusser.removeAttr("disabled"), a.focus && this.focusser.focus());
                    },
                    focus: function () {
                    ...
                    data: function (a) {
                        ...
                        return 0 === arguments.length
                            ...
                            : (arguments.length > 1 && (d = arguments[1]),
                              a
                                  ? ((c = this.data()), this.opts.element.val(a ? this.id(a) : ""), this.updateSelection(a), d && this.triggerChange({ added: a, removed: c }))
                                  : this.clear(d),
                              void 0);
                    },
                })),
                        ...
                        if ((d = b.data("select2-data"))) {
                            ...
                            (f.val = this.id(d)),
                                ...
                                f.isDefaultPrevented() ||
                                    (b.remove(), this.opts.element.trigger({ type: "select2-removed", val: this.id(d), choice: d }), this.triggerChange({ removed: d }));
                        }
                    },
                    postprocessResults: function (a, b, c) {
                        var d = this.getVal(),
                    ...
                    return (
                        this.each(function () {
                            if (0 === c.length || "object" == typeof c[0])
                                ...
                                if (
                                    ((h = c[0]),
                                    "container" === h ? (i = g.container) : "dropdown" === h ? (i = g.dropdown) : (n[h] && (h = n[h]), (i = g[h].apply(g, c.slice(1)))),
