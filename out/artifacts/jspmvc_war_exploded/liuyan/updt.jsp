...
<div style="padding: 10px" class="admin-content">
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">编辑留言:</div>
            <div class="panel-body">
                <form action="liuyan.do?ac=update" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <textarea style="width: 80%; height: 120px" class="form-control" placeholder="输入留言内容" id="liuyanneirong" name="liuyanneirong">
${Info.html(mmm.liuyanneirong)}</textarea
                                >
                            </div>
                        </div>
                    </div>
