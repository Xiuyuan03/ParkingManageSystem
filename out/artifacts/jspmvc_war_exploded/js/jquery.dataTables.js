            ...
            var DataTable = function (oInit) {
                ...
                function _fnScrollDraw(o) {
                    ...
                    if ($(o.nTable).outerWidth() < iSanityWidth) {
                        ...
                        var iCorrection =
                            nScrollBody.scrollHeight > nScrollBody.offsetHeight || $(nScrollBody).css("overflow-y") == "scroll" ? iSanityWidth + o.oScroll.iBarWidth : iSanityWidth;
                            ...
                            for (i = 0; i < oSettings.aoColumns.length; i++) {
                                if (oSettings.aoColumns[i].bVisible) {
                                    if (oSettings.aoColumns[i].sWidthOrig === null) {
                                        ...
                                        iTotal +=
                                            parseInt(oSettings.aoColumns[i].sWidth.replace("px", ""), 10) + ($(oNodes[iCorrector]).outerWidth() - $(oNodes[iCorrector]).width());
                                    }
                                    iCorrector++;
                                }
                            }
