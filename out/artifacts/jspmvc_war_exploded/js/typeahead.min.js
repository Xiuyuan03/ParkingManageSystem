...
!(function (a) {
    var b = "0.9.3",
        ...
        g = (function () {
            ...
            return (
                c.mixin(a.prototype, {
                    ...
                    set: function (a, b) {
                        var c;
                        this.cachedKeysByAge.length === this.sizeLimit && ((c = this.cachedKeysByAge.shift()), delete this.cache[c]),
                            (this.cache[a] = b),
        ...
        l = (function () {
            ...
            return (
                c.isMsie() && c.mixin(h.query, { backgroundImage: "url(data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)" }),
                ...
                c.mixin(b.prototype, d, {
                    ...
                    _autocomplete: function (a) {
                        ...
                        (("rightKeyed" !== a.type && "leftKeyed" !== a.type) ||
                            ...
                            "" !== e &&
                                d !== e &&
                                ((f = this.dropdownView.getFirstSuggestion()), this.inputView.setInputValue(f.value), this.eventBus.trigger("autocompleted", f.datum, f.dataset)));
                    },
