...
<div style="padding: 10px" class="admin-content">
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">添加IC卡信息:</div>
            <div class="panel-body">
                <form action="ickaxinxi.do?ac=insert" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="输入卡号" style="width: 250px" id="kahao" name="kahao" value="" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="输入持卡人" style="width: 150px" id="chikaren" name="chikaren" value="" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
