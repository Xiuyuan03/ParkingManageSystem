            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" id="formSearch" action="?">
                    ...
                    <div class="form-group">
                        ...
                        <script>
                            $(".class_leixing9 select-update").val($(".class_leixing9 select-update").attr("data-value"));
                        </script>
                    </div>
                    <div class="form-group">
                        收费金额
                    ...
                    <tbody>
                        <c:set var="i" value="0" /><c:forEach items="${list}" var="map"
                            ...
                            <tr id="${map.id}" pid="">
                                ...
                                <td>
                                    <ssm:sql var="maptingcheweixinxi3" type="find">SELECT tingchechangmingcheng,id FROM tingcheweixinxi where id='${map.weizhi}'</ssm:sql
                                    >${maptingcheweixinxi3.tingchechangmingcheng}
                                </td>
