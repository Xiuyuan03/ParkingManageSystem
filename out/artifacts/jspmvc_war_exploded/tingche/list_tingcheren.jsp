...
<div style="padding: 10px" class="admin-content">
    <div class="panel panel-default">
        <div class="panel-heading">
            <span class="module-name"> 停车 </span>
            <span>列表</span>
        </div>
            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" id="formSearch" action="?">
                    ...
                    <div class="form-group">
                        ...
                        <script>
                            $(".class_leixing10 select-update").val($(".class_leixing10 select-update").attr("data-value"));
                        </script>
                    </div>
                    <div class="form-group">
                        收费金额
                    ...
                    <tbody>
                        <c:set var="i" value="0" /><c:forEach items="${list}" var="map"
                            ...
                            <tr id="${map.id}" pid="">
                                ...
                                <td>
                                    <ssm:sql var="maptingcheweixinxi4" type="find">SELECT tingchechangmingcheng,id FROM tingcheweixinxi where id='${map.weizhi}'</ssm:sql
                                    >${maptingcheweixinxi4.tingchechangmingcheng}
                                </td>
                                ...
                                <td align="center">
                                    <c:if test="${Query.make('chuchang').where('tingcheid',map.id).count() ==0}">
                                    <a href="chuchang.do?ac=add&id=${map.id}">出场</a>
                                    </c:if>
                                    <a href="tingche.do?ac=detail&id=${map.id}">详情</a>

                                    <a href="tingche.do?ac=updt&id=${map.id}">编辑</a>

                                    <a href="tingche.do?ac=delete&id=${map.id}" onclick="return confirm('确定要删除？')">删除</a>
                                    <!--qiatnalijne-->
                                </td>
                            </tr>
                        </c:forEach>
