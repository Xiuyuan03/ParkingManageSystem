...
<div style="padding: 10px" class="admin-content">
    <div class="panel panel-default">
        <div class="panel-heading">停车详情</div>
            ...
            <div class="admin-detail clearfix">
                ...
                <div class="detail detail-select">
                    ...
                    <div class="detail-content">
                        <ssm:sql var="maptingcheweixinxi5" type="find">SELECT tingchechangmingcheng,id FROM tingcheweixinxi where id='${map.weizhi}'</ssm:sql
                        >${maptingcheweixinxi5.tingchechangmingcheng}
                    </div>
                </div>
                <div class="detail detail-select">
                ...
                <div class="detail detail-selectupdate">
                    <div class="detail-title">IC卡：</div>
                    <div class="detail-content"></div>
                </div>
                <div class="detail detail-selectupdate">
                    <div class="detail-title">选择类型：</div>
                    <div class="detail-content"></div>
                </div>
