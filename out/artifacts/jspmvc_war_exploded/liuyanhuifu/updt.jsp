...
<div style="padding: 10px" class="admin-content">
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">编辑留言回复:</div>
            <div class="panel-body">
                <form action="liuyanhuifu.do?ac=update" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->

                    <input type="hidden" name="liuyanid" value="${mmm.liuyanid}" />
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">${mmm.liuyanren}<input type="hidden" id="liuyanren" name="liuyanren" value="${Info.html(mmm.liuyanren)}" /></div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
