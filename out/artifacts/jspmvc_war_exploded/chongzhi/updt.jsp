...
<div style="padding: 10px" class="admin-content">
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">编辑充值:</div>
            <div class="panel-body">
                <form action="chongzhi.do?ac=update" method="post" name="form1" id="form1">
                    <!-- form 标签开始 -->

                    <input type="hidden" name="ickaxinxiid" value="${mmm.ickaxinxiid}" />
