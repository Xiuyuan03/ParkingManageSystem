...
<div style="padding: 10px" class="admin-content">
    <div class="panel panel-default">
        <div class="panel-heading">反馈详情</div>
        <div class="panel-body">
            <div class="admin-detail clearfix">
                <div class="detail detail-readmodule">
                    <div class="detail-title">投诉id：</div>
                    <div class="detail-content">${map.tousuid}</div>
                </div>
                ...
                <div class="detail detail-textuser">
                    <div class="detail-title">反馈人：</div>
                    <div class="detail-content">${map.fankuiren}</div>
                </div>
                <div class="detail detail-editor">
                    <div class="detail-title">反馈内容：</div>
                    <div class="detail-content">${map.fankuineirong}</div>
                </div>
            </div>
