...
<html lang="en">
    ...
    <body>
        <div id="log-tbl">
            <div id="log-contain">
                <div id="logo" style="z-index: 100">后台登录</div>

                <div id="login">
                    <h3 class="text-center" style="margin-top: -30px; margin-bottom: 30px">基于Java停车场管理系统</h3>
                    <form id="login-form" class="form" method="post" action="user.do?ac=login&a=a&admin=1">
                        ...
                        <div class="form-group">
                            <div class="input-icon">
                                ...
                                <input class="form-control form-soft input-sm" name="pwd" id="login-password" placeholder="密码" type="password" />
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" style="display: inline-block; width: 180px" name="pagerandom" placeholder="验证码" required="" />
                            <img
                                alt="刷新验证码"
                        ...
                        <div class="form-group">
                            ...
                            <a href="yonghu.do?ac=add" class="btn btn-primary btn-block btn-lg">用户注册</a>
                        </div>
                    </form>
                </div>
            </div>
