...
<div style="padding: 10px" class="admin-content">
    <div class="panel panel-default">
        <div class="panel-heading">message reply detail</div>
        <div class="panel-body">
            <div class="admin-detail clearfix">
                <div class="detail detail-readmodule">
                    <div class="detail-title">messageid:</div>
                    <div class="detail-content">${map.message_id}</div>
                </div>
                ...
                <div class="detail detail-textuser">
                    <div class="detail-title">respondent:</div>
                    <div class="detail-content">${map.respondent}</div>
                </div>
                <div class="detail detail-textarea">
                    <div class="detail-title">content:</div>
