...
<head>
    ...
    <title>Java-based parking lot management system background management</title>
    ...
    <div class="left hidden-xs">
        ...
        <div class="sidebar">
            <div class="accordion">
                ...
                <c:choose>
                    <c:when test="${'user' == sessionScope.cx }">
        ...
        <div class="nav">
            <div class="bar">
                ...
                <ul class="nav nav-pills hidden-xs" style="margin-left: 40px;">
                    <li class="active"><a href="javascript:;"> Java-based parking lot management system</a></li>
                    <!--<li><a href="#"><span class="icon icon-barcode"></span>Labels <span class="label label-primary">1,078</span></a>
                    </li>-->
                    <li><a href="./"><span class="icon icon-home"></span>front page</a></li>
                    <li><a href="user.do?ac=logout" onclick="return confirm('OK to exit？')"><span
                            class="icon icon-home"></span>sign out</a></li>
                </ul>
            ...
            <div class="crumbs">
                <ol class="breadcrumb hidden-xs">
                    <li><i class="icon icon-home"></i> <a href="sy.jsp" target="main">welcome page</a></li>
                    <li class="active"></li>
                </ol>
            </div>
        </div>
