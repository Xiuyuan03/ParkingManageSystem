    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="feedback.do?ac=insert" method="post" name="form1" id="form1">


                    <input type="hidden" name="complain_id" value="${param.id}" />
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">${readMap.complainant}<input type="hidden" id="complainant" name="complainant" value="${Info.html(readMap.complainant)}" /></div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <label style="text-align: right" class="col-sm-2 hiddex-xs">feedback content</label>
                            <div class="col-sm-10">
