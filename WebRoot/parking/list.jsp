            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" id="formSearch" action="?">
                    ...
                    <div class="form-group">
                        ...
                        <script>
                            $(".class_type9 select-update").val($(".class_type9 select-update").attr("data-value"));
                        </script>
                    </div>
                    <div class="form-group">
                        charge amount
                    ...
                    <tbody>
                        <c:set var="i" value="0" /><c:forEach items="${list}" var="map"
                            ...
                            <tr id="${map.id}" pid="">
                                ...
                                <td>
                                    <ssm:sql var="mapparking_information3" type="find">SELECT parking_lot_name,id FROM parking_information where id='${map.location}'</ssm:sql
                                    >${mapparking_information3.parking_lot_name}
                                </td>
                                <td>${map.park_time}</td>
