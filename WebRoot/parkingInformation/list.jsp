                    ...
                    <tbody>
                        <c:set var="i" value="0" /><c:forEach items="${list}" var="map"
                            ...
                            <tr id="${map.id}" pid="">
                                ...
                                <td>${map.columns}</td>
                                <td align="center">
                                    <a href="parkingInformation.do?ac=detail&id=${map.id}">detail</a>

                                    <a href="parkingInformation.do?ac=updt&id=${map.id}">edit</a>

                                    <a href="parkingInformation.do?ac=delete&id=${map.id}" onclick="return confirm('Are you sure you want to delete? ')">delete</a>
                                    <!--qiatnalijne-->
                                </td>
                            </tr>
                        </c:forEach>
