...
(function (t, e) {
                                    ...
                                    var l = r.theme ? P(r.buttonIcons, i) : null,
                                        ...
                                        u = t(
                                            "<span class='fc-button fc-button-" +
                                                ...
                                                v +
                                                "-state-default'>" +
                                                (l ? "<span class='fc-icon-wrap'><span class='ui-icon ui-icon-" + l + "'/>" + "</span>" : c) +
                                                "</span>"
                                        )
                                            .click(function () {
    ...
    function Z(e, n, r) {
        ...
        function v() {
            ...
            for (a += "<tbody>", t = 0; ee > t; t++) {
                for (
                    a += "<tr class='fc-week'>", ue && ((n = Ee(t, 0)), (a += "<td class='fc-week-number " + r + "'>" + "<div>" + q(xe(n, ve)) + "</div>" + "</td>")), e = 0;
                    ne > e;
                    e++
                )
                    (n = Ee(t, e)), (a += h(n));
    ...
    function K(n, r, a) {
        ...
        function s() {
            ...
            for (
                c(),
                    ce = t("<div style='position:absolute;z-index:2;left:0;width:100%'/>").appendTo(n),
                    Ue("allDaySlot")
                        ? ((ue = t("<div class='fc-event-container' style='position:absolute;z-index:8;top:0;left:0'/>").appendTo(ce)),
                          ...
                          (ve = de.find("tr")),
                          C(ve.find("td")),
                          ce.append("<div class='fc-agenda-divider " + s + "'>" + "<div class='fc-agenda-divider-inner'/>" + "</div>"))
                        : (ue = t([])),
                    he = t("<div style='position:absolute;width:100%;overflow-x:hidden;overflow-y:auto'/>").appendTo(ce),
                    ge = t("<div style='position:relative;width:100%;overflow:hidden'/>").appendTo(he),
                    be = t("<div class='fc-event-container' style='position:absolute;z-index:8;top:0;left:0'/>").appendTo(ge),
        ...
        function g() {
            ...
            for (
                a += "<thead><tr>",
                    Xe
                        ? ((t = nn(0, 0)), (e = on(t, Ve)), Ye ? (e += Je) : (e = Je + e), (a += "<th class='fc-agenda-axis fc-week-number " + r + "'>" + q(e) + "</th>"))
                ...
                if (a >= 0 && We > a) {
                    ...
                    if (s > i) {
                        if (((o.top = i), (o.height = s - i), (o.left += 2), (o.width -= 5), t.isFunction(r))) {
                            ...
                            (o.isStart = !0),
                                (o.isEnd = !0),
                                (Me = t(en({ title: "", start: e, end: n, className: ["fc-select-helper"], editable: !1 }, o))),
        ...
        function s(n, r) {
            ...
            for (k[0].innerHTML = T, m = k.children(), a = 0; S > a; a++)
                (o = n[a]),
                    ...
                    D === !1
                        ? b.remove()
                        : (D && D !== !0 && (b.remove(), (b = t(D).css({ position: "absolute", top: o.top, left: o.left }).appendTo(k))),
                          (o.element = b),
            ...
            for (a = 0; S > a; a++)
                (o = n[a]),
                    (b = o.element) &&
                        ...
                        o.contentTop !== e &&
                            10 > M - o.contentTop &&
                            (b.find("div.fc-event-time").text(re(i.start, y("timeFormat")) + " - " + i.title), b.find("div.fc-event-title").remove()),
                                    ...
                                    (i = h(p, u)),
                                        n.row
                                            ? s
                                                ? c &&
                                                  (e.width(f - 10),
                                                  T(e, v * Math.round((t.end ? (t.end - t.start) / Re : y("defaultEventMinutes")) / g)),
        ...
        function g(t, e, n) {
            function r() {
                K(),
                    s &&
                        (f
                            ? (n.hide(), e.draggable("option", "grid", null), Q(l(d(t.start), b), l(C(t), b)))
                            : (a(D), n.css("display", ""), e.draggable("option", "grid", [T, x])));
            }
            function a(e) {
                var r,
                    a = u(d(t.start), e);
    ...
    function oe(t, n, r) {
        ...
        if (t.forwardCoord === e)
            for (
                o.length ? (o.sort(ce), oe(o[0], n + 1, r), (t.forwardCoord = o[0].backwardCoord)) : (t.forwardCoord = 1),
    ...
    (t.fn.fullCalendar = function (n) {
        ...
        return (
            ...
            (n = t.extend(!0, {}, Ce, n.isRTL || (n.isRTL === e && Ce.isRTL) ? Me : {}, n)),
