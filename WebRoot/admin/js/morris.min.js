                            ...
                            for (s = n = 0, r = e.length; n < r; s = ++n)
                                (f = e[s]),
                                    ...
                                    this.options.parseTime
                                        ...
                                        : ((a.x = s), this.options.xLabelFormat && (a.label = this.options.xLabelFormat(a))),
                                    (c = 0),
                                    (a.y = function () {
                                        var e, t, n, r;
                                        ...
                                        for (i = e = 0, t = n.length; e < t; i = ++e)
                                            (p = n[i]),
                                                ...
                                                m != null && (this.cumulative ? (c += m) : d != null ? ((d = Math.max(m, d)), (v = Math.min(m, v))) : (d = v = m)),
                                                this.cumulative && c != null && ((d = Math.max(c, d)), (v = Math.min(c, v))),
                                                r.push(m);
                                        return r;
                                    }.call(this)),
                                    o.push(a);
            ...
            return typeof e == "number"
                ...
                : ((n = e.match(/^(\d+) Q(\d)$/)),
                  ...
                  n
                      ...
                      : u
                      ? ((l = new Date(parseInt(u[1], 10), 0, 1)), l.getDay() !== 4 && l.setMonth(0, 1 + ((4 - l.getDay() + 7) % 7)), l.getTime() + parseInt(u[2], 10) * 6048e5)
                      : a
                      ? a[6]
                          ? ((o = 0),
                            a[6] !== "Z" && ((o = parseInt(a[8], 10) * 60 + parseInt(a[9], 10)), a[7] === "+" && (o = 0 - o)),
                            Date.UTC(parseInt(a[1], 10), parseInt(a[2], 10) - 1, parseInt(a[3], 10), parseInt(a[4], 10), parseInt(a[5], 10) + o))
                          : new Date(parseInt(a[1], 10), parseInt(a[2], 10) - 1, parseInt(a[3], 10), parseInt(a[4], 10), parseInt(a[5], 10)).getTime()
                      : f
                      ? ((c = parseFloat(f[6])),
                        (t = Math.floor(c)),
                        ...
                        f[8]
                            ? ((o = 0),
                              f[8] !== "Z" && ((o = parseInt(f[10], 10) * 60 + parseInt(f[11], 10)), f[9] === "+" && (o = 0 - o)),
                              Date.UTC(parseInt(f[1], 10), parseInt(f[2], 10) - 1, parseInt(f[3], 10), parseInt(f[4], 10), parseInt(f[5], 10) + o, t, r))
                            : new Date(parseInt(f[1], 10), parseInt(f[2], 10) - 1, parseInt(f[3], 10), parseInt(f[4], 10), parseInt(f[5], 10), t, r).getTime())
            ...
            return (
                ...
                (n.prototype.moveTo = function (e, t) {
                    ...
                    return (
                        ...
                        t != null ? ((u = t - n - 10), u < 0 && ((u = t + 10), u + n > s && (u = s / 2 - n / 2))) : (u = s / 2 - n / 2),
            ...
            return (
                ...
                (n.prototype.generatePaths = function () {
                    ...
                    return (this.paths = function () {
                        ...
                        for (r = o = 0, u = this.options.ykeys.length; 0 <= u ? o < u : o > u; r = 0 <= u ? ++o : --o)
                            (s = this.options.smooth === !0 || ((f = this.options.ykeys[r]), a.call(this.options.smooth, f) >= 0)),
                                (n = function () {
                                    var e, t, n, s;
                                    (n = this.data), (s = []);
                    ...
                    (u = this.bottom + this.options.padding / 2),
                        ...
                        (e = function (e, t) {
                            ...
                            return (
                                ...
                                (r = n.getBBox()),
                                (s == null || s >= r.x + r.width || (i != null && i >= r.x)) && r.x >= 0 && r.x + r.width < c.el.width()
                                    ? (c.options.xLabelAngle !== 0 && ((o = (1.25 * c.options.gridTextSize) / Math.sin((c.options.xLabelAngle * Math.PI) / 180)), (i = r.x - o)),
                    ...
                    for (r = o = 0, u = e.length; o < u; r = ++o)
                        (t = e[r]),
                            t.y != null
                                ? ((i = e[r + 1] || { y: null }),
                                  (s = e[r - 1] || { y: null }),
                                  s.y != null && i.y != null ? a.push(n(s, i)) : s.y != null ? a.push(n(s, t)) : i.y != null ? a.push(n(t, i)) : a.push(null))
                                : a.push(null);
                    return a;
                }),
                ...
                (n.prototype.colorFor = function (e, t, n) {
                    return typeof this.options.lineColors == "function"
                        ...
                        : n === "point"
                        ? this.options.pointFillColors[t % this.options.pointFillColors.length] || this.options.lineColors[t % this.options.lineColors.length]
        ...
        (t.Area = (function (n) {
            ...
            return (
                ...
                (i.prototype._drawFillFor = function (e) {
                    ...
                    if (t !== null)
                        return (
                            (t += "L" + this.transX(this.xmax) + "," + this.bottom + "L" + this.transX(this.xmin) + "," + this.bottom + "Z"),
                ...
                (i.prototype.fillForSeries = function (e) {
                    ...
                    return (
                        ...
                        Raphael.hsl(t.h, this.options.behaveLikeLine ? t.s * 0.9 : t.s * 0.75, Math.min(0.98, this.options.behaveLikeLine ? t.l * 1.2 : t.l * 1.25))
                    );
                }),
            ...
            return (
                ...
                (r.prototype.drawXAxis = function () {
                    ...
                    for (e = l = 0, c = this.data.length; 0 <= c ? l < c : l > c; e = 0 <= c ? ++l : --l)
                        (u = this.data[this.data.length - 1 - e]),
                            ...
                            this.options.xLabelAngle !== 0 && ((i = -0.5 * a.width * Math.cos((this.options.xLabelAngle * Math.PI) / 180)), t.transform("t" + i + ",0...")),
                            (o == null || o >= n.x + n.width || (s != null && s >= n.x)) && n.x >= 0 && n.x + n.width < this.el.width()
                                ? (this.options.xLabelAngle !== 0 &&
                                      ((r = (1.25 * this.options.gridTextSize) / Math.sin((this.options.xLabelAngle * Math.PI) / 180)), (s = n.x - r)),
                                    ...
                                    m.push(
                                        function () {
                                            ...
                                            for (f = u = 0, d = v.length; u < d; f = ++u)
                                                (h = v[f]),
                                                    h !== null
                                                        ? (p ? ((c = Math.min(h, p)), (t = Math.max(h, p))) : ((c = h), (t = this.bottom)),
                                                          (s = this.left + r * n + o),
                ...
                (r.prototype.hitTest = function (e, t) {
                    return this.data.length === 0
                        ? null
                        : ((e = Math.max(Math.min(e, this.right), this.left)), Math.min(this.data.length - 1, Math.floor((e - this.left) / (this.width / this.data.length))));
                }),
                    ...
                    for (n = o = 0, u = a.length; o < u; n = ++o)
                        (s = a[n]),
                            (t +=
                                ...
                                "\n</div>");
                    return (
                        typeof this.options.hoverCallback == "function" && (t = this.options.hoverCallback(e, this.options, t)),
            ...
            return (
                ...
                (r.prototype.setLabels = function (e, t) {
                    ...
                    return (
                        ...
                        this.text1.attr({ transform: "S" + u + "," + u + "," + (o.x + o.width / 2) + "," + (o.y + o.height) }),
