...
$.extend($.fn.dataTableExt.oPagination, {
    bs_normal: {
        fnInit: function (oSettings, nPaging, fnDraw) {
            ...
            $(nPaging).append(
                '<ul class="pagination">' +
                    '<li class="prev disabled"><a href="#"><span class="glyphicon glyphicon-chevron-left"></span>&nbsp;' +
                    oLang.sPrevious +
                    "</a></li>" +
    ...
    bs_two_button: {
        fnInit: function (oSettings, nPaging, fnCallbackDraw) {
            ...
            var sAppend =
                '<ul class="pagination">' +
                '<li class="prev"><a href="#" class="' +
                oSettings.oClasses.sPagePrevDisabled +
                '" tabindex="' +
                oSettings.iTabIndex +
                '" role="button"><span class="glyphicon glyphicon-chevron-left"></span>&nbsp;' +
                oLang.sPrevious +
                "</a></li>" +
                '<li class="next"><a href="#" class="' +
    ...
    bs_four_button: {
        fnInit: function (oSettings, nPaging, fnCallbackDraw) {
            ...
            $(nPaging).append(
                '<ul class="pagination">' +
                    '<li class="disabled"><a href="#" tabindex="' +
                    oSettings.iTabIndex +
                    '" class="' +
