...
<div style="padding: 10px" class="admin-content">
    <div class="panel panel-default">
        <div class="panel-heading">
            <span class="module-name"> complaint </span>
            <span>list</span>
        </div>
                    ...
                    <tbody>
                        <c:set var="i" value="0" /><c:forEach items="${list}" var="map"
                            ...
                            <tr id="${map.id}" pid="">
                                ...
                                <td align="center">
                                    <c:if test="${Query.make('feedback').where('complaint_id',map.id).count() ==0}">
                                    <a href="feedback.do?ac=add&id=${map.id}">feedback</a>
                                    </c:if>
                                    <a href="complaint.do?ac=detail&id=${map.id}">detail</a>

                                    <a href="complaint.do?ac=updt&id=${map.id}">edit</a>

                                    <a href="complaint.do?ac=delete&id=${map.id}" onclick="return confirm('Are you sure you want to delete? ')">delete</a>
                                    <!--qiatnalijne-->
                                </td>
                            </tr>
                        </c:forEach>
