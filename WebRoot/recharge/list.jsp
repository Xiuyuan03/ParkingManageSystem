                ...
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    <thead>
                        <tr align="center">
                            ...
                            <th>operator</th>
                            <th width="80" data-field="is_paid">isPaid</th>
                                ...
                                <td>
                                    ...
                                    <c:choose>
                                        <c:when test="${'no' == map.is_paid }">
                                            <a href="javascript:window.open('paid/index.jsp?id=${map.id}&biao=chongzhi&ordersn=${map.serial_number}&zongji=${map.recharge_amount}')">
                                                to pay
                                            </a>
                                        </c:when></c:choose
                                    >
