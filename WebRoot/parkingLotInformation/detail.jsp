            ...
            <div class="admin-detail clearfix">
                ...
                <div class="detail detail-select">
                    ...
                    <div class="detail-content">
                        <ssm:sql var="mapparking_information2" type="find">SELECT parking_lot_name,id FROM parking_information where id='${map.location}'</ssm:sql
                        >${mapparking_information2.parking_lot_name}
                    </div>
                </div>
                <div class="detail detail-editor">
                    <div class="detail-title">parking introduction:</div>
                    <div class="detail-content">${map.introduction}</div>
                </div>
            </div>
