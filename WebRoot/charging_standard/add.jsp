...
<div style="padding: 10px" class="admin-content">
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">Add charging standards:</div>
            <div class="panel-body">
                <form action="charging_standard.do?ac=insert" method="post" name="form1" id="form1">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control class_type7" data-value="" id="type" name="type" style="width: 250px">
