...
<div style="padding: 10px" class="admin-content">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="pa10 bg-warning">
                <form class="form-inline" id="formSearch" action="?">
                    ...
                    <div class="form-group">
                        ...
                        <script>
                            $(".class_type18 select-update").val($(".class_type18 select-update").attr("data-value"));
                        </script>
                    </div>
                    <div class="form-group">
                        charge amount
                    ...
                    <tbody>
                        <c:set var="i" value="0" /><c:forEach items="${list}" var="map"
                            ...
                            <tr id="${map.id}" pid="">
                                ...
                                <td>
                                    <ssm:sql var="mapparking_information9" type="find">SELECT parking_lot_name,id FROM parking_information where id='${map.location}'</ssm:sql
                                    >${mapparking_information9.parking_lot_name}
                                </td>
                                <td>${map.park_time}</td>
            ...
            <p>sum amount: ${total.sum_amount} 　　</p>
        </div>
    </div>
</div>
