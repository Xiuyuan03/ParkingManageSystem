...
<div style="padding: 10px" class="admin-content">
    <div class="panel panel-default">
        <div class="panel-heading">outOfParking detail</div>
        <div class="panel-body">
            <div class="admin-detail clearfix">
                <div class="detail detail-readmodule">
                    <div class="detail-title">parking id:</div>
                    <div class="detail-content">${map.parking_id}</div>
                </div>
                <div class="detail detail-readmodule">
                ...
                <div class="detail detail-select">
                    ...
                    <div class="detail-content">
                        <ssm:sql var="mapparking_information10" type="find">SELECT parking_lot_name,id FROM parking_information where id='${map.location}'</ssm:sql
                        >${mapparking_information10.parking_lot_name}
                    </div>
                </div>
                <div class="detail detail-select">
                ...
                <div class="detail detail-datetime">
                    <div class="detail-title">exit time:</div>
                    <div class="detail-content">${map.exit_time}</div>
                </div>
                ...
                <div class="detail detail-money">
                    ...
                    <div class="detail-content">${map.amount}</div>
                </div>
                ...
                <div class="detail detail-difftime">
                    ...
                    <div class="detail-content">${map.duration}</div>
                </div>
            </div>
