...
$(document).ready(function () {
    ...
    $(".wdgt").each(function (index) {
        var wbtns = "";
        if ($(this).attr("ajax-btn") == "true") {
            wbtns += "<i class='fa fa-refresh wdgt-ajax'></i>";
        }
        if ($(this).attr("hide-btn") == "true") {
            wbtns += "<i class='fa fa-minus wdgt-hide'></i>";
        }
        if ($(this).attr("close-btn") == "true") {
            wbtns += "<i class='fa fa-times wdgt-close'></i>";
        }
        $(this)
            .find(".wdgt-header")
            .html($(this).find(".wdgt-header").html() + "<span>" + wbtns + "</span>");
    });

    /* WIDGET HANDLERS */
    $(".wdgt-close").click(function () {
